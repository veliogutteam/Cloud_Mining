...
create_clock -add -name sys_clk_pin -period 14.28 -waveform {0 7.14} [get_ports {clk}];
#create_clock -add -name sys_clk_pin -period 100.0 -waveform {0 50} [get_ports {clk}];
...
#set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { tx_active }]; #IO_L20N_T3_A07_D23_14 Sch=led[14]
