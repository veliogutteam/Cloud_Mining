...
HD_PWD='D:/Archive/notes/Ozyegin_MSc/2021-2022_Fall/CS550/Project/BtcMiner/BtcMiner.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BtcMiner.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BtcMiner.tcl -notrace
