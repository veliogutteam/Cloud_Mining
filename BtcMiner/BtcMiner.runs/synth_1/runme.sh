...
HD_PWD='D:/Archive/notes/Ozyegin_MSc/2021-2022_Fall/CS550/Project/BtcMiner/BtcMiner.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BtcMiner.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BtcMiner.tcl
